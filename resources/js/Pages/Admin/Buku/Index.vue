        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <tr>
              ...
              <td>$penerbit</td>
              <td align="center">
                <Link href="/admin/buku/1/edit" class="btn btn-xs btn-info mr-1" title="Edit"><i class="fas fa-edit"></i></Link>
                <Link href="/admin/buku/1" class="btn btn-xs btn-info mr-1" title="Detail"><i class="fas fa-eye"></i></Link>
                <Link href="#" class="btn btn-xs btn-warning"><i class="fas fa-trash" title="Hapus"></i></Link>
              </td>
            </tr>
          </tbody>
        </table>
