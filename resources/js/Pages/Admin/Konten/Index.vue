        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <tr>
              ...
              <td>$tanggal</td>
              <td align="center">
                <Link href="/admin/konten/1/edit" class="btn btn-xs btn-info mr-1"><i class="fas fa-edit"></i></Link>
                <Link href="/admin/konten/1" class="btn btn-xs btn-info mr-1" title="Detail"><i class="fas fa-eye"></i></Link>
