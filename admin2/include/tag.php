          ...
          ?>
            <tr>
              ...
              <td align="center">
                ...
                <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?= $tag ?>?'))window.location.href = 'index.php?include=tag&aksi=hapus&data=<?= $id_tag ?>&notif=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i>Hapus</a>
              </td>
            </tr>
          <?php $no++;
          } ?>
