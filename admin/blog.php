            ...
            <ul class="pagination pagination-sm m-0 float-right">
              ...
              if ($jum_halaman == 1) {
                ...
                if (isset($_GET['katakunci'])) {
                  $katakunci = $_GET['katakunci'];
                  if ($halaman != 1) {
                    echo "<li class='page-item'><a class='page-link' href='blog.php?katakunci=$katakunci&halaman=1'>First</a></li>";
                    echo "<li class='page-item'><a class='page-link' href='blog.php?katakunci=$katakunci&halaman=$sebelum'>&laquo;</a></li>";
                  }
                  for ($i = 1; $i <= $jum_halaman; $i++) {
                    if ($i > $halaman - 5 && $i < $halaman + 5) {
                      if ($i != $halaman) {
                        echo "<li class='page-item'><a class='page-link' href='blog.php?katakunci=$katakunci&halaman=$i'>$i</a></li>";
                      } else {
                  ...
                  if ($halaman != $jum_halaman) {
                    echo "<li class='page-item'><a class='page-link' href='blog.php?katakunci=$katakunci&halaman=$setelah'>&raquo;</a></li>";
                    echo "<li class='page-item'><a class='page-link' href='blog.php?katakunci=$katakunci&halaman=$jum_halaman'>Last</a></li>";
                  }
                } else {
                  if ($halaman != 1) {
